...
#define SPI_DELAY_COUNT_MS 4 //100 //24 //loop itteration for ius delay depends by HW speed
...
//set spi outputs
#define cmt_spi3_sdio_1()       P01=1
#define cmt_spi3_sdio_0()       P01=0

#define cmt_spi3_sclk_1()       P10=1
#define cmt_spi3_sclk_0()       P10=0

#define cmt_spi3_csb_1()        P12=1  //set_P2_3
#define cmt_spi3_csb_0()        P12=0  //clr_P2_3

#define cmt_spi3_fcsb_1()       P11=1  //set_P2_2
#define cmt_spi3_fcsb_0()       P11=0  //clr_P2_2
    

//read SPI data
#define cmt_spi3_sdio_read()    P01

//read gpion input controls
#define CMT2300A_ReadGpio1()    P00//P14
#define CMT2300A_ReadGpio2()    P00//P13
#define CMT2300A_ReadGpio3()    P15//P2^4
...
//port control 
#define CMT2300A_ReadRTS()     P03 
#define CMT2300A_WriteCTS_1()  P02=1
#define CMT2300A_WriteCTS_0()  P02=0

//on-board LED
#define CMT2300A_WriteTST_1()   P03=1
#define CMT2300A_WriteTST_0()   P03=0
